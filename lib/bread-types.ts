...
export const BREAD_RECIPES: Record<BreadType, BreadRecipeConfig> = {
  ...
  focaccia: {
    ...
    slug: "focaccia",
    description:
      "פוקצ'ה היא הלחם הכי נסלח לשגיאות שיש וזה הופך את ההכנה שלו למושלמת למתחילים. בצק בהידרציה גבוהה, שמן זית נדיב בתוך ועל הבצק, ותסיסה ארוכה שיוצרת מבנה אוורירי עם בועות גדולות. אפשר להוסיף עליה כל דבר – עגבניות שרי, זיתים, שום, רוזמרין – וכל גרסה תצא נהדרת.",
    hydration: 82,
    salt: 2,
    levainType: "sourdough",
    starterPercentage: 20,
  ...
  challah: {
    ...
    slug: "challah",
    description:
      "חלת שבת היא הלחם הכי ישראלי שיש. קלועה, רכה להפליא, עם קרום מבריק ממריחת ביצה ופנים ספוגי ועשיר. בניגוד ללחמים האחרים כאן, החלה היא לחם עם שמרים מסחריים ובצק מתוק-עשיר (enriched dough), מה שאומר שהתהליך קצר יותר ותצליח בה כמעט בוודאות. הקליעה היא מיומנות שמשתפרת בכל אפייה.",
    hydration: 60,
    salt: 1.8,
    levainType: "yeast",
    yeastPercentage: 1.5,
